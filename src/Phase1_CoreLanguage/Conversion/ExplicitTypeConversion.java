package Phase1_CoreLanguage.Conversion;
...
//////        //    ch = num;
    ...
    private void explicitTypeConversion() {
        ...
        int i = 257;
        double d = 323.142;
        System.out.println("Basics.Conversion of int to byte.");

        //i%256
        b = (byte) i;
        System.out.println("i = " + i + " b = " + b);
        System.out.println("\nBasics.Conversion of double to byte.");
        ...
        //OUTPUT
        //Basics.Conversion of int to byte.
        //i = 257 b = 1
        //
        //Basics.Conversion of double to byte.
        //d = 323.142 b= 67
