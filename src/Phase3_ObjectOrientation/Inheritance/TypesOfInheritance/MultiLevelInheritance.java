package Phase3_ObjectOrientation.Inheritance.TypesOfInheritance;

/**In Multilevel OOPSConcepts.Inheritance, a derived class will be inheriting a base class and as well as the derived class also act as the base class to other class.
